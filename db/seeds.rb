...
Room.create!(:hotel_id => 1, :name => '20', :room_type => "Suit", :bed_number => 4, :price => 44.99, :cleaned => true)
Room.create!(:hotel_id => 2, :name => '20', :room_type => "Suit", :bed_number => 2, :price => 34.99, :cleaned => false)
